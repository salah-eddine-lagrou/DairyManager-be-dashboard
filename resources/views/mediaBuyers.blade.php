...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
                    ...
                    <div class="container-fluid">
                        <nav
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="Search for client ..." class="form-control" />
                            </div>
                        </nav>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Media Buyers Page</h3>
                        </div>
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="#" class="btn btn-secondary btn-round me-2" data-toggle="modal"
                                data-target="#addMediaBuyerModal">Add Media Buyer</a>
                            <a href="#" class="btn btn-primary btn-round" id="exportLeadBtn">Export Media
                                Buyers
                                File</a>
                        </div>
                    </div>
                        ...
                        <div class="card card-round">
                            <div class="card-header">
                                <div class="card-head-row card-tools-still-right">
                                    <div class="card-title">All Media Buyers</div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">name MB</td>
                                                <td class="text-center">client.name@example.com</td>
                                                <td class="text-center">
                                                    <span class="badge badge-dark">+99 products</span>
                                                </td>
            ...
            {{-- modal form add Lead --}}
            <div class="modal fade" id="addMediaBuyerModal" tabindex="-1" role="dialog" aria-labelledby="addMediaBuyerModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Add Media Buyer</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="addMediaBuyerForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputSource" placeholder="Enter Source">
                                </div>
                                <button type="submit" class="btn btn-primary">Save Media Buyer</button>
                            </form>
                        </div>
                    </div>
                </div>
