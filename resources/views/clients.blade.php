            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Clients Page</h3>
                        </div>
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="#" class="btn btn-secondary btn-round me-2" data-toggle="modal"
                                data-target="#addClientModal">Add Client</a>
                            <a href="#" class="btn btn-primary btn-round" id="exportLeadBtn">Export Clients
                                File</a>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">Name client</td>
                                                <td class="text-center">0123456789</td>
                                                <td class="text-center">client.name@example.com</td>
                                                <td class="text-center">Sale, kenitra 0123</td>
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-primary ms-2" title="View">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-secondary ms-2" title="Edit">
